package fr.upmc.components.extensions.synchronizers.components.syncTools;

import java.io.Serializable;
import java.util.UUID;

import fr.upmc.components.AbstractComponent;
import fr.upmc.components.extensions.synchronizers.interfaces.syncTools.arrayBlockingQueue.ArrayBlockingQueueConnectionI;
import fr.upmc.components.extensions.synchronizers.interfaces.syncTools.arrayBlockingQueue.ArrayBlockingQueuePutI;
import fr.upmc.components.extensions.synchronizers.interfaces.syncTools.arrayBlockingQueue.ArrayBlockingQueueTakeI;
import fr.upmc.components.extensions.synchronizers.ports.syncTools.arrayBlockingQueue.ArrayBlockingQueueConnectionInboundPort;
import fr.upmc.components.extensions.synchronizers.ports.syncTools.arrayBlockingQueue.ArrayBlockingQueuePutInboundPort;
import fr.upmc.components.extensions.synchronizers.ports.syncTools.arrayBlockingQueue.ArrayBlockingQueueTakeInboundPort;
