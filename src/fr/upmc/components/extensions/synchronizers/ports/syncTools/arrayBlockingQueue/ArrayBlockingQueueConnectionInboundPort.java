package fr.upmc.components.extensions.synchronizers.ports.syncTools.arrayBlockingQueue;

import fr.upmc.components.ComponentI;
import fr.upmc.components.extensions.synchronizers.components.syncTools.ArrayBlockingQueue;
...
implements ArrayBlockingQueueConnectionI
{
	...
	/**
	 * @see fr.upmc.components.extensions.synchronizers.interfaces.syncTools.arrayBlockingQueue.ArrayBlockingQueueConnectionI#getOwnPortURI(boolean)
	 */
	@Override
