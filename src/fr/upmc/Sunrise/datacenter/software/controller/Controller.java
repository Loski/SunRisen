package fr.upmc.Sunrise.datacenter.software.controller;
...
import fr.upmc.Sunrise.datacenter.hardware.computer.connector.ComputerControllerConnector;
import fr.upmc.Sunrise.datacenter.hardware.computer.interfaces.ComputerControllerManagementI;
import fr.upmc.Sunrise.datacenter.hardware.computer.ports.ComputerControllerManagementOutboutPort;
import fr.upmc.Sunrise.datacenter.hardware.processors.ProcessorsController.CoreAsk;
import fr.upmc.Sunrise.datacenter.hardware.processors.connector.ProcessorControllerManagementConnector;
import fr.upmc.Sunrise.datacenter.hardware.processors.interfaces.ProcessorsControllerManagementI;
import fr.upmc.Sunrise.datacenter.hardware.processors.ports.ProcessorsControllerManagementOutboundPort;
import fr.upmc.Sunrise.datacenter.software.admissioncontroller.AdmissionControllerDynamic;
import fr.upmc.Sunrise.datacenter.software.admissioncontroller.connector.AdmissionControllerManagementConnector;
import fr.upmc.Sunrise.datacenter.software.admissioncontroller.interfaces.AdmissionControllerManagementI;
import fr.upmc.Sunrise.datacenter.software.admissioncontroller.ports.AdmissionControllerManagementOutboundPort;
import fr.upmc.Sunrise.datacenter.software.applicationvm.ApplicationVMInfo;
import fr.upmc.Sunrise.datacenter.software.controller.connectors.NodeManagementConnector;
...
import fr.upmc.Sunrise.datacenter.software.controller.ports.NodeManagementInboundPort;
import fr.upmc.Sunrise.datacenter.software.controller.ports.NodeManagementOutboundPort;
import fr.upmc.Sunrise.datacenter.software.controller.ports.VMDisconnectionNotificationHandlerInboundPort;
import fr.upmc.Sunrise.datacenter.software.requestdispatcher.RequestDispatcher.RequestDispatcherPortTypes;
import fr.upmc.Sunrise.datacenter.software.requestdispatcher.connectors.RequestDispatcherIntrospectionConnector;
import fr.upmc.Sunrise.datacenter.software.requestdispatcher.connectors.RequestDispatcherManagementConnector;
...
import fr.upmc.Sunrise.datacenter.software.requestdispatcher.ports.RequestDispatcherDynamicStateDataOutboundPort;
import fr.upmc.Sunrise.datacenter.software.requestdispatcher.ports.RequestDispatcherIntrospectionOutboundPort;
import fr.upmc.Sunrise.datacenter.software.requestdispatcher.ports.RequestDispatcherManagementOutboundPort;
import fr.upmc.Sunrise.datacenter.software.ring.RingDynamicState;
import fr.upmc.Sunrise.datacenter.software.ring.interfaces.RingNetworkDynamicStateI;
import fr.upmc.Sunrise.datacenter.software.ring.interfaces.RingNetworkStateDataConsumerI;
import fr.upmc.Sunrise.datacenter.software.ring.ports.RingNetworkDynamicStateDataInboundPort;
import fr.upmc.Sunrise.datacenter.software.ring.ports.RingNetworkDynamicStateDataOutboundPort;
import fr.upmc.Sunrise.datacenter.tools.Writter;
			...
			VMDisconnectionNotificationHandlerI
{
	...
	/** 
	 * @see fr.upmc.Sunrise.datacenter.software.requestdispatcher.interfaces.RequestDispatcherStateDataConsumerI#acceptRequestDispatcherDynamicData(java.lang.String, fr.upmc.Sunrise.datacenter.software.requestdispatcher.interfaces.RequestDispatcherDynamicStateI)
	 */
	...
	/**
	 * @see fr.upmc.Sunrise.datacenter.software.requestdispatcher.interfaces.RequestDispatcherStateDataConsumerI#acceptRequestDispatcherStaticData(java.lang.String, fr.upmc.Sunrise.datacenter.software.requestdispatcher.interfaces.RequestDispatcherStaticStateI)
	 */
	@Override
...
/*	private int setCoreFrequency(CoreAsk ask, ApplicationVMDynamicStateI vm){
	...
	*/
	...
	/**
	 * @see fr.upmc.Sunrise.datacenter.software.ring.interfaces.RingNetworkStateDataConsumerI#acceptRingNetworkDynamicData(java.lang.String, fr.upmc.Sunrise.datacenter.software.ring.interfaces.RingNetworkDynamicStateI)
	 */
	@Override
	...
	/**
	 * @see fr.upmc.Sunrise.datacenter.software.controller.interfaces.VMDisconnectionNotificationHandlerI#disconnectController()
	 */
	@Override
