...
public class ApplicationProviderManagementOutboundPort extends AbstractOutboundPort implements ApplicationProviderManagementI{
	...
	/**
	 * @see fr.upmc.Sunrise.datacenterclient.software.applicationprovider.interfaces.ApplicationProviderManagementI#createAndSendApplication()
	 */
	@Override
	...
	/**
	 * @see fr.upmc.Sunrise.datacenterclient.software.applicationprovider.interfaces.ApplicationProviderManagementI#stopApplication()
	 */
	@Override
	...
	/**
	 * @see fr.upmc.Sunrise.datacenterclient.software.applicationprovider.interfaces.ApplicationProviderManagementI#createAndSendApplication(java.lang.Class)
	 */
